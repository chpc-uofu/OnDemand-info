...
OodFilesApp.candidate_favorite_paths.tap do |paths|
  ...
  paths << Pathname.new("/scratch/general/pe-nfs1/#{User.new.name}")
  ...
  OodSupport::User.new.groups.each do |group|
    #paths.concat Pathname.glob("/uufs/chpc.utah.edu/common/HIPAA/#{group.name}-group*")
    #paths.concat Pathname.glob("/uufs/chpc.utah.edu/common/HIPAA/#{*")
  end
end
