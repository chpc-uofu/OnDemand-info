...
local root = "/uufs/chpc.utah.edu/sys/installdir/rstudio-singularity/3.6.2"
-- local bin = pathJoin(root, "/bin")
local img = pathJoin(root, "ood-bioconductor_3.6.2.sif")
local library = pathJoin(root, "/library-ood-3.6")
local host_mnt = ""

local user_library = os.getenv("HOME") .. "/R/library-ood-bioconductor-3.6"
