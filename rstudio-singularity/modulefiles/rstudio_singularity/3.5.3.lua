...
local root = "/uufs/chpc.utah.edu/sys/installdir/rstudio-singularity/1.1.463"
-- local bin = pathJoin(root, "/bin")
local img = pathJoin(root, "singularity-rstudio_3.5.3.sif")
local library = pathJoin(root, "/library-3.5")
local host_mnt = ""

local user_library = os.getenv("HOME") .. "/R/library-3.5"
